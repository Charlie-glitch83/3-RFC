...
- Run workspace: `modules/E/runs/E-140-20260807T041433Z`
...
5. Run `python tools/run_reference_checks.py --module E --output modules/E/runs/E-140-20260807T041433Z/reference_checks.json`.
6. Bind and run the prebuilt local engines listed below. Every `__BIND_` token is a hard stop:

   - `python tools/director.py solver-copy --module E --solver reaction_network --destination modules/E/runs/E-140-20260807T041433Z`
   ...
   - `python tools/materialize_solver_config.py --template modules/E/runs/E-140-20260807T041433Z/solver_templates/E_reaction_network.template.json --binding-sheet modules/E/runs/E-140-20260807T041433Z/binding_sheets/E_reaction_network.bindings.json --output modules/E/runs/E-140-20260807T041433Z/solver_configs/E_reaction_network.json`
   - `python tools/run_configured_solver.py --config modules/E/runs/E-140-20260807T041433Z/solver_configs/E_reaction_network.json --output-dir modules/E/runs/E-140-20260807T041433Z/solver_outputs/reaction_network`
