...
- Run workspace: `modules/D/runs/D-130-20260807T220342Z`
...
5. Run `python tools/run_reference_checks.py --module D --output modules/D/runs/D-130-20260807T220342Z/reference_checks.json`.
6. Bind and run the prebuilt local engines listed below. Every `__BIND_` token is a hard stop:

   - `python tools/director.py solver-copy --module D --solver transport --destination modules/D/runs/D-130-20260807T220342Z`
   ...
   - `python tools/materialize_solver_config.py --template modules/D/runs/D-130-20260807T220342Z/solver_templates/D_transport.template.json --binding-sheet modules/D/runs/D-130-20260807T220342Z/binding_sheets/D_transport.bindings.json --output modules/D/runs/D-130-20260807T220342Z/solver_configs/D_transport.json`
   - `python tools/run_configured_solver.py --config modules/D/runs/D-130-20260807T220342Z/solver_configs/D_transport.json --output-dir modules/D/runs/D-130-20260807T220342Z/solver_outputs/transport`
