...
- Run workspace: `modules/I/runs/I-180-20260810T134326Z`
...
5. Run `python tools/run_reference_checks.py --module I --output modules/I/runs/I-180-20260810T134326Z/reference_checks.json`.
6. Bind and run the prebuilt local engines listed below. Every `__BIND_` token is a hard stop:

   - `python tools/director.py solver-copy --module I --solver transport --destination modules/I/runs/I-180-20260810T134326Z`
   ...
   - `python tools/materialize_solver_config.py --template modules/I/runs/I-180-20260810T134326Z/solver_templates/I_background_ode.template.json --binding-sheet modules/I/runs/I-180-20260810T134326Z/binding_sheets/I_background_ode.bindings.json --output modules/I/runs/I-180-20260810T134326Z/solver_configs/I_background_ode.json`
   - `python tools/run_configured_solver.py --config modules/I/runs/I-180-20260810T134326Z/solver_configs/I_background_ode.json --output-dir modules/I/runs/I-180-20260810T134326Z/solver_outputs/transport`
