...
No superseding G physical route realization, replayed HU transfer, repaired I physical geometry, repaired HI state or J state is established yet.
...
- G160-I-CHILD-INTERFACE-DEFECT-20260810: Historical G-160 promoted implementation-only fixed-rate recombination evidence to PHYSICALLY_EXECUTED and marked H_G_to_I child-ready without route-resolved process activity or geometry-child ancestry.
