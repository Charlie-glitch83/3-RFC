...
checks={
 ...
 'independent_symbolic_and_numerical_checks': independent['pass'] is True and solver['success'] is True and reference['overall']=='PASS' and str(wl1['result']).startswith('PASS') and str(wl2['result']).startswith('PASS') and counter['overall']=='PASS'
}
