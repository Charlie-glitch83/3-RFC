...
ev={
 'typed operator':['primary/HU175_TYPED_OPERATOR.json'],
 'domain and codomain':['primary/HU175_TYPED_OPERATOR.json'],
 'gauge/frame contracts':['primary/HU175_CONSTRAINT_GAUGE_FRAME_CONTRACT.json'],
 'conservation and constraint identities':['primary/HU175_CONSTRAINT_GAUGE_FRAME_CONTRACT.json'],
 'operator uncertainty':['primary/HU175_OPERATOR_UNCERTAINTY.json'],
 'frozen H_HU_to_HI':['../../frozen/H_HU_to_HI_v2.json']
}
...
gates['overall']='PASS'
gates['componentwise']['covariance, restart and clean replay']={'pass':True,'clean_replay':True,'artifact_hashes_match':True,'evidence':'REPLAY_RECORD.json'}
...
claim={
 ...
 'evidence':['modules/HU/frozen/H_HU_to_HI_v2.json',f'modules/HU/runs/{RID}/independent/INDEPENDENT_RECONSTRUCTION.json',f'modules/HU/runs/{RID}/REPLAY_RECORD.json'],
